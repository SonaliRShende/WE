const mr = {
  ...
  auth: {
    ...
    signUp: "साइन अप",
    formNote: "तुमची निवडलेली वेबसाइट भाषा साइन इन केल्यानंतरही सक्रिय राहील."
  },
  voice: {
  ...
  jobSeekerForm: {
    ...
    requiredAlert: "कृपया सर्व आवश्यक फील्ड भरा: नाव, ईमेल आणि स्थान.",
  ...
  jobProviderForm: {
    ...
    requiredAlert: "कृपया सर्व आवश्यक फील्ड भरा: नाव, ईमेल, फोन नंबर, नोकरीचे शीर्षक आणि नोकरीचे वर्णन.",
