const hi = {
  ...
  jobSeekerForm: {
    ...
    requiredAlert: "कृपया सभी आवश्यक फ़ील्ड भरें: नाम, ईमेल और स्थान।",
  ...
  jobProviderForm: {
    ...
    requiredAlert: "कृपया सभी आवश्यक फ़ील्ड भरें: नाम, ईमेल, फोन नंबर, नौकरी का शीर्षक और नौकरी का विवरण।",
