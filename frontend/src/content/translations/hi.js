const hi = {
  ...
  landing: {
    ...
    featureTitle: "आत्मविश्वासी करियर और बेहतर भर्ती के लिए डिज़ाइन किया गया",
    featureIntro: "प्रतिभा दिखाने से लेकर सही अवसर खोजने तक, हर कदम भर्ती को सहज, संरचित और प्रभावशाली बनाने के लिए तैयार किया गया है।",
    features: [
      {
        title: "शक्तिशाली प्रोफ़ाइल",
        description: "उम्मीदवार अपने कौशल, अनुभव और आकांक्षाओं को स्पष्टता और आत्मविश्वास के साथ प्रदर्शित कर सकते हैं।"
      },
      {
        title: "उद्देश्यपूर्ण नौकरी पोस्टिंग",
        description: "नियोक्ता ऐसी विस्तृत अवसर पोस्ट कर सकते हैं जो भूमिकाओं, अपेक्षाओं और विकास की संभावनाओं को स्पष्ट रूप से परिभाषित करें।"
      },
      {
        title: "सरल निर्णय प्रक्रिया",
        description: "स्मार्ट डैशबोर्ड प्रोफ़ाइल, अवसर और भर्ती से जुड़ी जानकारी को एक साथ लाकर तेज़ और अधिक केंद्रित निर्णय लेने में मदद करते हैं।"
      }
    ],
    stats: [],
  ...
  auth: {
    ...
    signUp: "साइन अप",
    formNote: "आपकी चुनी हुई वेबसाइट भाषा साइन इन के बाद भी सक्रिय रहेगी।"
  },
  voice: {
